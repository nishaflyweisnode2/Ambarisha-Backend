...
exports.getCart = async (req, res) => {
  try {
    ...
    const cart = await Cart.findOne({ userId }).populate('products.productId', 'name price').populate('address membership userMembership subscription uerrSubscription plan');
